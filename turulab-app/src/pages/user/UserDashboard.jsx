    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-lg text-gray-600 mt-2">
          Siap untuk memulai perjalanan tidur sehat Anda,{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-4 rounded-lg shadow-md border border-gray-200">
          <p className="text-gray-400">
            <span className="text-primary font-bold">Prediction</span> |
            Prediction in just seconds
          </p>
          <div className="flex gap-x-3 mt-3">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2 text-sm">
                ...
                of quick predictions include faster decision-making and improved
                user experience.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-x-3 mt-3">
            ...
            <div>
              <p className="text-lg font-bold text-primary">
                Click "Smart Prediction"
              </p>
              <p className="text-gray-600 mt-2 text-sm">
                <span className="text-green-700 font-semibold">Fill out</span>{" "}
                the PSQI questionnaire to get your sleep quality prediction.
              </p>
            </div>
          </div>
        </div>
          ...
          {lastPrediction ? (
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              ...
              <div className="mt-6">
                <h3 className="text-xl font-bold text-gray-800">
                  Kualitas Tidur: {lastPrediction.predicted_result}
                </h3>
                <p className="text-gray-600 mt-2">
                  Rekomendasi kami berdasarkan nilai tertinggi dari hasil
                  dibawah ini.
                </p>
              </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center border border-dashed">
              ...
              <p className="text-gray-500 mt-2">
                Anda belum pernah mengisi kuesioner. Mulai sekarang untuk
        ...
        <div className="md:col-span-1">
          <div className="bg-blue-50 p-6 rounded-lg shadow-md border border-blue-200 h-full flex flex-col justify-center">
            ...
            <p className="text-gray-600 mb-6">
              Isi kuesioner PSQI untuk mendapatkan analisis dan rekomendasi
              terbaru mengenai pola tidur Anda.
            </p>
            <Link
              to="/kuesioner"
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">
          Rekomendasi Tidur Berdasarkan Komponen
        </h2>
