...
const TABS = [
  {
    key: "C1",
    label: "C1",
    description: "Kualitas Tidur Subjektif (Subjective Sleep Quality)",
  },
  ...
  { key: "C3", label: "C3", description: "Durasi Tidur (Sleep Duration)" },
  {
    key: "C4",
    label: "C4",
    description: "Efisiensi Tidur (Habitual Sleep Efficiency)",
  },
  {
    key: "C5",
    label: "C5",
    description: "Gangguan Tidur (Sleep Disturbances)",
  },
  {
    key: "C6",
    label: "C6",
    description: "Penggunaan Obat Tidur (Use of Sleeping Medication)",
  },
  {
    key: "C7",
    label: "C7",
    description: "Disfungsi Siang Hari (Daytime Dysfunction)",
  },
];
      ...
      <div className="grid grid-cols-7 border-b border-gray-400 bg-white rounded-t-lg shadow">
        {TABS.map((tab) => (
          <button
            ...
            className={`px-4 rounded py-2 font-semibold border-b-2 transition-colors duration-200 ${
              activeTab === tab.key
                ? "bg-primary text-white border-blue-600"
                : "text-gray-700 border-transparent hover:bg-blue-100"
            }`}
          >
            {tab.label}
          </button>
